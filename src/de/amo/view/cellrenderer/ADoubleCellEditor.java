 ...
 */
public class ADoubleCellEditor extends DefaultCellEditor {
...
//    public ADoubleCellEditor(double min, double max) {
    public ADoubleCellEditor() {

        super(new JFormattedTextField());
        ftf = (JFormattedTextField) getComponent();
        minimum = new Double(Double.MIN_VALUE);
        maximum = new Double(Double.MAX_VALUE);
